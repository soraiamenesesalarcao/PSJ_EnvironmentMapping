...
/*bool SceneManager::isMouseOver(std::string id){
...
void SceneManager::init(){
	...
	//_postProgram = ProgramShader::getInstance()->createShaderProgram("shaders/vertexPostProcessing.glsl", s "shaders/fragmentPostProcessing.glsl");
